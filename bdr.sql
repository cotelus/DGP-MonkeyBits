...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-12-2018 a las 17:15:11
...
(10, '', 'usuariobloqueado@gmail.com', 'fsfsefa', 'asfsae', 'fsefs'),
(11, '', 'usuario1@gmail.com', 'fsfa', 'fasef', 'sasfes'),
(12, '', 'usuariobloqueado@gmail.com', 'afsefas', 'asfas', 'asfesf'),
(16, '', 'usuario1@gmail.com', 'afsfe', 'asef', 'asfes');
...
--
ALTER TABLE `place`
  MODIFY `IdPlace` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT de la tabla `route`
--
ALTER TABLE `route`
  MODIFY `IdRoute` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `suggestedroute`
  MODIFY `IdRoute` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
